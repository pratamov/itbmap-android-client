 ...
 */
public class GetMapByUuid extends AsyncTask<String, Integer, Map> {

    GetMapByUuidListener getMapByUuidListener;

    public GetMapByUuid(GetMapByUuidListener getMapByUuidListener) {
        this.getMapByUuidListener = getMapByUuidListener;
    }

    @Override
    protected Map doInBackground(String... params) {
        String uuid = params[0];
        String url = "http://216.126.192.36/itbmap/v1/beacons/"+uuid;
        try {
            ...
            getMapByUuidListener.onGetMapByUuidListenerError(e.getMessage());
        }
        return null;
    }

    protected void onPostExecute(Map map) {
        getMapByUuidListener.onGetMapByUuidListenerComplete(map);
    }
}
